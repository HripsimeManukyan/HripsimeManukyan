...
![Cypress](https://img.shields.io/badge/Cypress-E2E_Testing-brightgreen?logo=cypress)
...
> It features dynamic test data, token-based authentication via `.env`, error handling, and HTML/JSON reporting via Mochawesome.  
...
- **Security & performance testing fundamentals**
